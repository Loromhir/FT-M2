...
span.innerHTML= span.innerHTML + ' Lorenzo';
...
function displayToDos() {
  ...
  let build= buildToDos(toDoItems); //3
    for (let i = 0; i < build.length; i++) { //4
...
function addToDo() {
  ...
  if( input.value !== ''){
    var toDo= new ToDo(input.value); //1
...
let add = document.querySelector('#addButton') //1
